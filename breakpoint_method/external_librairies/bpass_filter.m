...
% image_min=255-double(imread('16_05_2012_200µm_test5_2_0001.png'));
% image_min=image_min(:,:,1);
% arr=double(imread('16_05_2012_200µm_test5_2_1860.png'));
% arr=arr(:,:,1);
% arr=arr-image_min;
% imagesc(arr)
% arr=arr(:,:,1)-double(image_min);

% image_min=255-imread('04_06_2012_test4_1_0002.png');
% image_min=image_min(:,:,1);
% im1=255-imread('04_06_2012_test4_1_0004.png');
% im1=im1(:,:,1);
%  im1=im1-image_min;
%  arr=im1;
%  max1=max(max(arr));
