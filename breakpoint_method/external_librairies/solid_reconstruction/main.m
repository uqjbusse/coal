...
%params.map                      = gray(256);  %Set colormap to something that is similar to wood
...
% 
% base_filename = '11Tpre (296).jpg';                  %Filename of non-moving image  
% move_filename = '11Tpost (272).jpg';                  %Filename of image that will move to the base image
